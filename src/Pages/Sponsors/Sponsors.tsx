            ...
            <div className="Sponsors">
                ...
                <div className="row">
                    <div className="col-sm-7 offset-sm-1 mx-auto">
                        <img className="Sponsors-img" src="/sponsors/ge-healthcare.png" alt="" />
                ...
                <div className="row">
                    <div className="col-sm-5 offset-sm-1">
                        <img className="Sponsors-img" src="/sponsors/krones.png" alt="" />
                        <img className="Sponsors-img" src="/sponsors/nokia-bell-labs.png" alt="" />
                        <img className="Sponsors-img" src="/sponsors/eaton.png" alt="" />
                    </div>
                ...
                <div className="row">
                    <div className="col-sm-5 offset-sm-1">
                        ...
                        <img className="Sponsors-img" src="/sponsors/drexel.jpg" alt="" />
                        
                    </div>
                    <div className="col-sm-5">
                        <img className="Sponsors-img" src="/sponsors/nb-plastics.png" alt="" />
                        <img className="Sponsors-img" src="/sponsors/cat.png" alt="" />
                        <img className="Sponsors-img" src="/sponsors/wem.png" alt="" />
                    </div>
                </div>
                <div className="row">
                    <div className="col-sm-10 offset-sm-1 pt-1">
                ...
                <div className="row">
                    <div className="col-sm-5 offset-sm-1">
                        ...
                        <img className="Sponsors-img-sm" src="/sponsors/bliffert.png" alt="" />
                    </div>
                    <div className="col-sm-5">
                        <img className="Sponsors-img" src="/sponsors/alpha-omega-cleaning.png" alt="" />
                        <img className="Sponsors-img-sm" src="/sponsors/toolrite.png" alt="" />
                        <h3 className="Sponsors-img text-center">Boy Scouts Pack 41</h3>
